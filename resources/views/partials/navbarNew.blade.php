    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav p-4 p-lg-0" style="margin-left: 300px;">
                <a href="indexSena" class="nav-item nav-link active">Home</a>
                <a href="#first" class="nav-item nav-link">About</a>
                <a href="#second" class="nav-item nav-link">Job Listed</a>
